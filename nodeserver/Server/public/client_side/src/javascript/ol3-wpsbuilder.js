...
wps.process = function (options) {
  ...
  this.localWPS = 'http://localhost:8080/geoserver/wps';
  this.localWFS = 'http://localhost:8080/geoserver/wfs';
  this.localWCS = 'http://localhost:8080/geoserver/wcs';
  ...
  this.configure({
    ...
    callback: function () {
      ...
      (function callback() {
        ...
        me.client.unmarshaller = context.createUnmarshaller();
...
wps.process.prototype.parseDescription = function (description) {
  ...
  this.client.unmarshaller = unmarshaller;
